...
DESIGN_COVERAGE = {
    "ai-first interface": ["ai-first", "guardian_check", "guardian_radar", "guardian_extract_page_facts", "guardian_capture_targets", "guardian_perceive"],
...
def check_static_contracts() -> CheckSet:
    ...
    guardian_terms = {
        ...
        "guardian_extract_page_facts marks value danger facts without capture": ["action_guardian_extract_page_facts", "value_danger_classified", "redacted_answer_ready", "dangerous_objects", "structured extraction from caller-supplied readonly observations"],
        ...
        "capture chain is prepare only": ["action_prepare_capture_chain", "capture_chain_request", "does not execute screenshots, browser navigation, scripts, APIs, subagents, or background schedulers", "CAPTURE_CHAIN_ALLOWED_STEP_TOOLS"],
        ...
        "registered commands map through a registry": ["CAPABILITY_COMMANDS", "action_guardian_list_commands", "action_guardian_run_command", "required_surface"],
