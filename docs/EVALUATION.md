...
- whether `guardian_extract_page_facts` can move a caller-supplied page observation into `redacted_answer_ready` with valuable objects, dangerous objects, and structured API facts
